...
const beforeEmitFactory = (node, RED) => {
    ...
    msg, value) => {
        if (node.allowColorForValueInMessage === true &&
            ...
            const greenarrowMsg = msg;
            const msgColorForValue = greenarrowMsg.colorForValue;
