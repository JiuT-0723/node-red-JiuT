...
const beforeEmitFactory = (node, RED) => {
    ...
    msg, value) => {
        if (node.allowColorForValueInMessage === true &&
            ...
            const redcrossMsg = msg;
            const msgColorForValue = redcrossMsg.colorForValue;
